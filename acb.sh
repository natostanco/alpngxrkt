...
apt-get update && apt-get install wget curl sudo systemd-container -y -q
cd /home/save/
acbuild begin /home/save/alpine.aci
acbuild set-name natostanco/alpngxrkt
acbuild run -- /bin/sh -c "apk --no-cache --update upgrade && apk add --no-cache openssl nginx apr apr-util libjpeg-turbo icu pcre"
...
acbuild write --overwrite /home/save/alpngxrkt.aci || return 1
